...
export const TOLPAT: TolppaLocation[] = [
  ...
  { name: "Helsingin kaupunginteatteri", aliases: ["HKT", "Kaupunginteatteri", "Hkt", "Linnanmäki"], lat: 60.1846, lon: 24.9532, zone: "Helsinki keskusta", number: 18, street: "Eläintarhantie / HKT" },
  ...
  { name: "Bulevardi", aliases: ["Bulevardi 17", "G Livelab", "G Live Lab", "G Livelab Helsinki"], lat: 60.1663, lon: 24.9392, zone: "Helsinki keskusta", number: 17, street: "Bulevardi / Yrjönkatu" },
...
const VENUE_TOLPPA_OVERRIDES: Record<string, string> = {
  ...
  "tavastia": "Kamppi",
  // Käyttäjän vahvistamat (taksikenttä-tieto)
  "malmitalo": "Malmitalo",
  "stoa": "Itäkeskus",
  "konepaja": "Kallio",
  "vallilan konepaja": "Kallio",
  "teurastamo": "Kalasatama",
  "tukkutori": "Kalasatama",
  "suvilahti": "Kalasatama",
  "g livelab": "Bulevardi",
  "g live lab": "Bulevardi",
  "g livelab helsinki": "Bulevardi",
  "kaisaniemen puisto": "Kaisaniemi",
  "on the rocks": "Rautatientori",
  "on the rocks helsinki": "Rautatientori",
  // Klubit / business
...
export const VENUE_GEO: Record<string, { lat: number; lon: number }> = {
  ...
  "konepaja": { lat: 60.1928, lon: 24.9437 },
  "vallilan konepaja": { lat: 60.1928, lon: 24.9437 },
  "teurastamo": { lat: 60.1859, lon: 24.9755 },
  "tukkutori": { lat: 60.1859, lon: 24.9755 },
  "suvilahti": { lat: 60.1850, lon: 24.9740 },
  ...
  "g livelab": { lat: 60.1663, lon: 24.9392 },
  "g live lab": { lat: 60.1663, lon: 24.9392 },
  "on the rocks": { lat: 60.1710, lon: 24.9418 },
